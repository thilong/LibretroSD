...
namespace libRetroRunner {
    ...
    void init_default_android_retro_button_map(int16_t *map_arrays, bool *map_state) {
    ...
    void SoftwareInput::Init() {
        ...
        init_default_android_retro_button_map((int16_t *) button_map, (bool *) have_button_map);
    }
    ...
    void SoftwareInput::UpdateButton(unsigned int port, unsigned int button, bool pressed) {
        unsigned int mappedButton = button;
